...
import { fetchAccountBillings } from "@app/redux/accountManagement/slice";
...
export default function BillingList(props: any) {
  ...
  const [tableData, refreshFn, totalRecords, extra] = useFetchAccountBillings();
  ...
  const columns: any[] = [
    ...
    {
      title: "Org Fee Charges",
      dataIndex: "psbilofc",
      key: "psbilofc",
      align: "right",
    },
    {
      title: "O/S Billed Amt",
      dataIndex: "psbiloba",
      key: "psbiloba",
      align: "right",
    },
    ...
    <>
      <Card>
        ...
        <Table
          columns={columns}
          data={tableData}
          refreshFn={fetchAccountBillings}
