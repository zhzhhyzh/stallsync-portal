...
import {selectExtra, selectPromotions, selectTotal, getPromotionList, selectDwPromotions, getDownlinePromotions } from "@app/redux/promotion/slice";

function useFetchDWPromotions() {
  const dispatch = useAppDispatch();
  const router = useRouter();

  const data = useAppSelector(selectDwPromotions);
...
export default useFetchDWPromotions;
