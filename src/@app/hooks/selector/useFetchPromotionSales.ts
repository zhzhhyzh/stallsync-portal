...
import {selectExtra, selectSales, selectTotal, getSalesList } from "@app/redux/promotion/slice";

function useFetchPromotionSales() {
...
export default useFetchPromotionSales;
