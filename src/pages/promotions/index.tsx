...
import useFetchPromotions from "@app/hooks/selector/useFetchPromotions";
import {
  getPromotionList,
} from "@app/redux/promotion/slice";
...
export default function PromotionPage() {
  ...
  const { sendRequest, loading } = useApi({ title: "Promotion" });
  ...
  const [tableData, refreshFn, totalRecords, extra] = useFetchPromotions();
  ...
  const columns: any[] = [
    ...
    },
    {
      ...
      dataIndex: "psprmcurdsc",
      key: "psprmcurdsc",
    },
    {
      title: "New Designation",
      dataIndex: "psprmnxtdsc",
      key: "psprmnxtdsc",
    },
    {
      title: "Achieved Date",
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
          <Space size="small">
            ...
            /> */}
            {
              (homeData?.access && checkAccessMatrix(homeData?.access, accessType.PROMOTION_EDIT)) && (
            ...
            {/* {
              (homeData?.access && checkAccessMatrix(homeData?.access, accessType.PROMOTION_DEL)) && (
            ...
            <TableMenu menus={[
              ...
              // },
              // {
              //   url: `/Promotions/productFees`, //new subfolder place inside Promotions
              //   query: {
              //     // id: record?.id,
              //     prquecod: prquecod,
              //     prprodcd: record?.psfeecod,
    ...
    <>
      <Box>
        <Flex justifyContent={"space-between"} pl={4} pr={4} pt={4} py={Spacing.gap}>
          ...
          >
            {/* {
              (homeData?.access && checkAccessMatrix(homeData?.access, accessType.Promotion_ADD)) && (
                <Buttons 
