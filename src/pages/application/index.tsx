          ...
          >
            ...
            >
              ...
              >
                ...
                <CustomTabs label={`Pending Review (${extra?.count?.pending_review})`} index={1} selectedTabIndex={index} />
                <CustomTabs label={`Pending Approval (${extra?.count?.pending_approval})`} index={2} selectedTabIndex={index} />
                <CustomTabs label={`Approved (${extra?.count?.approved})`} index={3} selectedTabIndex={index} />
                <CustomTabs label={`Rejected (${extra?.count?.rejected})`} index={4} selectedTabIndex={index} />
