...
// import "/src/styles/group.css"; // Import the CSS file
  ...
  const [dateError, setDateError] = useState(false);
    const columns: any[] = [
      ...
      },
      {
        ...
        dataIndex: "psmbruid",
        key: "psmbruid",
        render: (_: string, record: any) => <>{`${record?.psmbrnme}, I/C ${record?.psaplidn} (${record?.psbnknme} A/C No: ${record?.psbnkacn})`}</>
      },
      {
        title: "Submission",
      ...
      },
      {
        ...
        render: (_: string, record: any) => <>{parseFloat(_).toFixed(2)}%</>
      },
      {
        title: "Personal",
